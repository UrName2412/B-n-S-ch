...
function Validator(options) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    // Định nghĩa hàm toggleDefaultInfo và gán vào window để có thể gọi từ HTML inline
    function toggleDefaultInfo() {
      const defaultCheckbox = document.getElementById('default-info-checkbox');
      if (!defaultCheckbox) return; // Kiểm tra xem phần tử có tồn tại không
    ...
    window.toggleDefaultInfo = toggleDefaultInfo; // Cho phép gọi từ HTML
