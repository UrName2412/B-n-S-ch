...
document.getElementById('priceFilterForm').addEventListener('submit', function (event) {
    ...
    const nhaXuatBan = document.getElementById('nxb').value.trim();
    ...
    loadProducts(category, minPrice, maxPrice, tenSach, tacGia, nhaXuatBan, theloai);  // Lọc sản phẩm theo giá
});
