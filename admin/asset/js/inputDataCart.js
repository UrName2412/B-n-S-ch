        ...
        newCartFix.innerHTML = `
            ...
            <div class="row-element">
                ...
                <select name="status" disabled>
                    <option value="Chưa xử lí" ${cart.status === "Chưa xử lí" ? "selected" : ""}>Chưa xử lí</option>
                    <option value="Đã xác nhận" ${cart.status === "Đã xác nhận" ? "selected" : ""}>Đã xác nhận</option>
                    <option value="Đã giao" ${cart.status === "Đã giao" ? "selected" : ""}>Đã giao</option>
                    <option value="Đã hủy" ${cart.status === "Đã hủy" ? "selected" : ""}>Đã hủy</option>
                </select>
            </div>
        `;
