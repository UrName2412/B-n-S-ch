...
const filterBtn = document.querySelector('.tool .filter');
...
const behindMenuFix = document.querySelector('.behindMenuFix');
...
fixBtn.addEventListener('click', () => {
    ...
    behindMenuFix.style.display = 'block';
})
...
if (behindMenuFix) {
    behindMenuFix.addEventListener('click', function () {
        toolMenu.style.display = 'none';
        toolMenu_fix_delete.style.display = 'none';
        addMenu.style.display = 'none';
        fixMenu.style.display = 'none';
