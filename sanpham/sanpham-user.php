...
<body>
    ...
    <!-- Product Section with PHP Pagination -->
                        ...
                        <div class="border p-5">
                            <div class="container my-4">
                                <div id="listProduct" class="listProduct row">
                                    ...
                                    // Truy vấn sản phẩm từ bảng b01_sanpham với LIMIT & OFFSET
        ...
        LIMIT $productsPerPage OFFSET $offset";
                      ...
                      <div class=\"col-md-4 mb-4\">
                          <div class=\"card\" style=\"width: 100%;\">
                              <a href=\"chitietsanpham-user.php?id={$row['maSach']}\">
                                  <img src=\"../Images/{$row['hinhAnh']}\" alt=\"{$row['tenSach']}\" class=\"card-img-top\">
                              </a>
                              <div class=\"card-body\">
            ...
            <footer class="text-white py-4">
                <div class="container">
                    <div class="row pb-4 footer__bar">
                        <div
                            class="col-md-12 d-flex justify-content-between fw-bold align-items-center footer__connect">
