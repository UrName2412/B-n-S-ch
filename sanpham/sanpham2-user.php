                ...
                <div class="border p-5">
                    <div class="container my-4">
                        <div class="listProduct row">
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/tuduymo.jpg" alt="Ảnh 10" class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Tư Duy Mở</h5>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/hanhtrinhvephuongdong.jpg" alt="Ảnh 11"
                                            class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Hành Trình Về Phương Đông</h5>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/conduongchangmayaidi.jpg" alt="Ảnh 12" class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Con Đường Chẳng Mấy Ai Đi</h5>
                                        <p class="card-text">Kỹ năng sống</p>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/thegioikhongconguoixau.jpg" alt="Ảnh 13"
                                            class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Thế Giới Không Có Người Xấu</h5>
                                        <p class="card-text">Kỹ năng sống</p>
                                        <p class="card-text text-danger fw-bold">68.000 đ</p>
                                        <button class="btn" style="background-color: #336799; color: #ffffff;">Thêm
                                            vào giỏ hàng</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/muonkiepnhansinh.jpg" alt="Ảnh 14" class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Muôn Kiếp Nhân Sinh</h5>
                                        <p class="card-text">Tôn giáo</p>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/chienbinhcauvong.jpg" alt="Ảnh 15" class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Chiến Binh Cầu Vòng</h5>
                                        <p class="card-text">Hồi ký</p>
                                        <p class="card-text text-danger fw-bold">80.000 đ</p>
                                        <button class="btn" style="background-color: #336799; color: #ffffff;">Thêm
                                            vào giỏ hàng</button>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/cuoccachmangglucose.jpg" alt="Ảnh 16" class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Cuộc Cách Mạng Glucose</h5>
                                        <p class="card-text">Khoa học kỹ thuật</p>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/100kinangsinhton.jpg" alt="Ảnh 17" class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">100 Kỹ Năng Sinh Tồn</h5>
                                        <p class="card-text">Kỹ năng sống</p>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card" style="width: 100%;">
                                    <a href="chitietsanpham-user.php">
                                        <img src="../Images/lamchutuoidoimuoi.jpg" alt="Ảnh 18" class="card-img-top">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Làm Chủ Tuổi Đôi Mươi</h5>
                                        <p class="card-text">Kỹ năng sống</p>
                                        <p class="card-text text-danger fw-bold">110.000 đ</p>
                                        <button class="btn" style="background-color: #336799; color: #ffffff;">Thêm
                                            vào giỏ hàng</button>
                                    </div>
                                </div>
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item">
                                <a class="page-link" href="sanpham-user.php"
                                    style="background-color: #336799; color: #ffffff;">Trước</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="sanpham-user.php"
                                    style="background-color: #336799; color: #ffffff;">1</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="#" style="background-color: #28527a; color: #ffffff;">2</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link" href="sanpham3-user.php"
