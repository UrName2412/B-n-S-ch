                    ...
                    <div class="col-md-5">
                        <div class="card" style="width: 100%;">
                            <div class="card-header d-flex justify-content-center text-white">
                                <h4 class="fw-bold my-1">ĐĂNG KÝ</h4>
                            </div>
                            <div class="card-body">
                                <form action="" name="signupform" id="signupform">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="password" name="pass-confirm" id="pass-confirm" placeholder="Xác nhận mật khảu">
                                    </div>
                                    <div class="mb-3">
                                        <input type="checkbox" class="form-check-input" id="terms" name="terms">
                                        <label class="form-check-label" for="terms">Tôi đồng ý với <a href="#"> điểu khoản và chính sách</a> của nhà sách.</label>
                                    </div>
