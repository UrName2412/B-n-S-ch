...
<body>
    ...
    <div class="container mt-3">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="sachthieunhi-nologin.php">Sách thiếu nhi</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="sachgiaokhoa-nologin.php">Sách giáo khoa</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="sachkinhte-nologin.php">Sách kinh tế</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="sachlichsu-nologin.php">Sách lịch sử</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="sachngoaingu-nologin.php">Sách ngoại ngữ</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="sachkhoahoc-nologin.php">Sách khoa học</a>
            </li>
        </ul>
    </div>
